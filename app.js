...
mongoose.connect('mongodb://localhost:27017/birthdayDB', { useNewUrlParser: true }, () => { console.log("connected to db") })
...
app.listen(3001, () => { console.log("Server started succesfully") })
